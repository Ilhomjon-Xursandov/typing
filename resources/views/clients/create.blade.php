                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="{{route('client.store')}}" method="POST">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" name="notes" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;"></textarea>
                            <label for="floatingTextarea">Notes</label>
                        </div>
                        <button type="submit" class="btn btn-outline-success m-2">Saqlash</button>
