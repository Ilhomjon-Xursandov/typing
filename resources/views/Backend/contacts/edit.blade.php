                ...
                <div class="bg-secondary rounded h-100 p-4">
                    <form action="{{ route('admin.contacts.update', $contact) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="path" value="{{ $contact->path }}" class="form-control" id="exampleInputText" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Telefon raqami 1 <b class="text-danger">*</b></label>
                            <input type="text" value="{{ $contact->phone1 }}" name="phone1" class="form-control" id="exampleInputText">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Telefon raqami 2</label>
                            <input type="text" value="{{ $contact->phone2 }}" name="phone2" class="form-control" id="exampleInputText">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Telefon raqami 3</label>
                            <input type="text" value="{{ $contact->phone3 }}" name="phone3" class="form-control" id="exampleInputText">
                        </div>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="email" value="{{ $contact->email1 }}"  name="email1" class="form-control" id="inputEmail3">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Email 3</label>
                        <div class="col-sm-10">
                            <input type="email" value="{{ $contact->email2 }}"  name="email2" class="form-control" id="inputEmail3">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Email 3</label>
                        <div class="col-sm-10">
                            <input type="email" value="{{ $contact->email3 }}"  name="email3" class="form-control" id="inputEmail3">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Telegram<b class="text-danger">*</b></label>
                        <div class="col-sm-10">
                            <input type="text" value="{{ $contact->telegram }}"  name="telegram" class="form-control" id="exampleInputText">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Instagram<b class="text-danger">*</b></label>
                        <div class="col-sm-10">
                            <input type="text" value="{{ $contact->instagram }}"  name="instagram" class="form-control" id="exampleInputText">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Facebook<b class="text-danger">*</b></label>
                        <div class="col-sm-10">
                            <input type="text" value="{{ $contact->facebook }}"  name="facebook" class="form-control" id="exampleInputText">
                        </div>
                    </div>
